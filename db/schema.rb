...
ActiveRecord::Schema.define(version: 20190128215151) do
  ...
  create_table "telephone_calls", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "vehicle_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_index "telephone_calls", ["user_id"], name: "index_telephone_calls_on_user_id", using: :btree
  add_index "telephone_calls", ["vehicle_id"], name: "index_telephone_calls_on_vehicle_id", using: :btree
